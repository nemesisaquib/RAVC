  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <header className="bg-gradient-to-r from-gray-800 to-gray-900 text-white rounded-2xl shadow-lg p-8 mb-10 text-center">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-6">
            This summary provides key highlights of our privacy policy. For more
            details about any of these topics, you can refer to the full notice
            below.
          </p>
        ...
        <div className="space-y-10">
          ...
          <Section
            ...
            text={
              <>
                <p className="mb-3">
                  The individual services and products (if any) provided by RAVC
                  are covered under their independent terms and conditions.
                </p>
                <p className="mb-3">
                ...
                <p>
                  Information may change from time to time and is indicative in
                  nature. For official details, please contact RAVC directly.
                </p>
              </>
            }
          />
