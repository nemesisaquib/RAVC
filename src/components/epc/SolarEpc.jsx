      ...
      <div className="relative z-10 max-w-[1400px] w-full px-4 py-12 flex flex-col md:flex-row items-center justify-center gap-10">
        ...
        <div className="w-full md:w-[55%] space-y-4">
          <motion.h1
            ...
            custom={0}
          >
            Turnkey Solar EPC Solutions for Utility, <br />Industrial & Institutional Clients
          </motion.h1>

          <motion.p
            className="text-gray-700 text-[16px] sm:text-[16px] md:text-[18px] lg:text-[18px] leading-[31.68px] text-justify"
            ...
            custom={1}
          >
            Our Engineering, Procurement & Construction (EPC) service covers the complete lifecycle of solar project delivery — from feasibility studies to full system commissioning. Whether greenfield or brownfield, our EPC model ensures structured planning, optimized procurement, and executional excellence to deliver high-quality solar plants — on time and on budget.
          </motion.p>
