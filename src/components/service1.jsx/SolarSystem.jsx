      ...
      <div className="relative z-10 max-w-[1400px] w-full px-4 py-12 flex flex-col md:flex-row items-center justify-center gap-10">
        ...
        <div className="w-full md:w-[55%] space-y-4">
          <motion.h1
            ...
            custom={0}
          >
            Scalable Rooftop Solar Systems for <br className="hidden sm:inline" /> Every Need
          </motion.h1>

          <motion.p
            className="text-gray-700 text-[16px] sm:text-[20px] lg:text-[22px] leading-[31.68px] text-justify"
          ...
          <motion.p
            ...
            custom={2}
          >
            Whether you're a factory owner, school administrator, or apartment association — our rooftop installations are engineered to deliver maximum output and long-term efficiency.
          </motion.p>
